...
CREATE TABLE IF NOT EXISTS session (
    ...
    CONSTRAINT fk_session_formation FOREIGN KEY (id_formation)
...
CREATE TABLE IF NOT EXISTS formateur (
    ...
    CONSTRAINT fk_formateur_personne1 FOREIGN KEY (id_formateur)
...
CREATE TABLE IF NOT EXISTS evaluation (
    ...
    CONSTRAINT fk_evaluation_module1 FOREIGN KEY (id_module)
        REFERENCES module (id_module)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_evaluation_session1 FOREIGN KEY (id_session)
        REFERENCES session (id_session)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_evaluation_formateur1 FOREIGN KEY (id_formateur)
...
CREATE TABLE IF NOT EXISTS module_formation (
    ...
    CONSTRAINT fk_module_has_formation_module1 FOREIGN KEY (id_module)
        REFERENCES module (id_module)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_module_has_formation_formation1 FOREIGN KEY (id_formation)
        REFERENCES formation (id_formation)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB$
...
CREATE TABLE IF NOT EXISTS candidature (
    ...
    CONSTRAINT fk_session_has_personne_session1 FOREIGN KEY (id_session)
        REFERENCES session (id_session)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_session_has_personne_personne1 FOREIGN KEY (id_personne)
        REFERENCES personne (id_personne)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_candidature_etat_candidature1 FOREIGN KEY (id_etat_candidature)
...
CREATE TABLE IF NOT EXISTS seance (
    ...
    UNIQUE INDEX `debut_UNIQUE` (`debut` ASC),
    UNIQUE INDEX `fin_UNIQUE` (`fin` ASC),
    CONSTRAINT fk_seance_module1 FOREIGN KEY (id_module)
        REFERENCES module (id_module)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_seance_session1 FOREIGN KEY (id_session)
        REFERENCES session (id_session)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_seance_formateur1 FOREIGN KEY (id_formateur)
        REFERENCES formateur (id_formateur)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_seance_salle1 FOREIGN KEY (id_salle)
...
CREATE TABLE IF NOT EXISTS note (
    ...
    CONSTRAINT fk_note_evaluation1 FOREIGN KEY (id_evaluation)
        REFERENCES evaluation (id_evaluation)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_note_personne1 FOREIGN KEY (id_personne)
        REFERENCES personne (id_personne)
        ON DELETE NO ACTION ON UPDATE NO ACTION
)  ENGINE=INNODB$
...
CREATE TABLE IF NOT EXISTS module_theme (
    ...
    CONSTRAINT fk_module_theme_module1 FOREIGN KEY (id_module)
        REFERENCES module (id_module)
        ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_module_theme_theme1 FOREIGN KEY (id_theme)
...
BEGIN
  ...
  INSERT INTO module
  (id_module, nom_module, objectif, contenu, nb_heures_annuel, prerequis) VALUES
  ...
  INSERT INTO seance
  (id_module, id_session, id_formateur, debut, fin, id_salle, contenu) VALUES
