...
public class PersonneDao implements Dao<Personne> {
	...
	private static String sqlValider = "UPDATE personne SET est_inscrite = true"
	...
	private static String sqlFindById = "select * from personne where id_personne = ? ;";
	 ...
	 *
	 * @param la
	 *            personne que l'on souhaite mettre à jour
	 * @return true or false
	 * @throws SQLException
	 */
	@Override
